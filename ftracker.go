...
func RunningSpentCalories(action int, weight, duration float64) float64 {
	...
	runCal := ((float64(runningCaloriesMeanSpeedMultiplier) * meanSpeedKmh * runningCaloriesMeanSpeedShift) * weight / mInKm * duration * minInH)
	return runCal
}
...
func WalkingSpentCalories(action int, duration, weight, height float64) float64 {
	...
	return ((walkingCaloriesWeightMultiplier*weight + (math.Pow(meanSpeedInMsec, 2)/heightInM)*
...
func SwimmingSpentCalories(lengthPool, countPool int, duration, weight float64) float64 {
	...
	swimcal := (swimmingMeanSpeed(lengthPool, countPool, duration) + swimmingCaloriesMeanSpeedShift) * 2 * weight * duration
	return swimcal
}
